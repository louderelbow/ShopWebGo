...
func (con DefaultController) Index(c *gin.Context) {
	fmt.Println(util.GetSettingFromColumn("SiteTitle"))
	//filename := "static/upload/gin.png"
	//util.ResizeGoodsImage(filename)
	c.String(200, "首页")
}
...
func (con DefaultController) Qrcode1(c *gin.Context) {
	var png []byte
	png, err := qrcode.Encode("https://www.mi.com", qrcode.Medium, 256)
	if err != nil {
...
func (con DefaultController) Qrcode2(c *gin.Context) {
	...
	err := qrcode.WriteFile("https://www.mi.com", qrcode.Medium, 556, savepath)
	if err != nil {
		c.String(200, "生成二维码失败")
		return
	}
